          ...
          <div className="p-4 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 border p-4">
              <div>
                ...
                <p>
                  <strong>City:</strong> {selectedUser.city?.replace(/"/g, "")}
                </p>
              </div>
              <div>
                <h3 className="font-bold text-lg border-b pb-1">
            ...
            <div className="border p-4">
              ...
              <div className="flex gap-4 flex-wrap mt-2">
                <div>
                  ...
                  <img
                    src={`${BASE_URL}/${selectedUser.idCardFront?.replace(
                      /\\/g,
                      "/"
                    )}`}
                    alt="ID Front"
                ...
                <div>
                  ...
                  <img
                    src={`${BASE_URL}/${selectedUser.idCardBack?.replace(
                      /\\/g,
                      "/"
                    )}`}
                    alt="ID Back"
                ...
                <div>
                  ...
                  <img
                    src={`${BASE_URL}/${selectedUser.selfieWithId?.replace(
                      /\\/g,
                      "/"
                    )}`}
                    alt="Selfie"
