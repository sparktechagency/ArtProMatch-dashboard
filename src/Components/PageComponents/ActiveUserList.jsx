  ...
  <div className="p-4">
    ...
    <div className="grid grid-cols-2 gap-4 border p-4 my-4">
      <div>
        ...
        <p>
          <strong>Latitude:</strong> {selectedUser.location?.coordinates[1]}
        </p>
        <p>
          <strong>Longitude:</strong> {selectedUser.location?.coordinates[0]}
        </p>
        <p>
    ...
    <div className="border p-4">
      <h3 className="font-semibold text-lg border-b pb-1">Other Info</h3>
      <p>
